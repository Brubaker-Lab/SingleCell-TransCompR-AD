...
write.xlsx(fgsea_list, file = paste0(home_dir, "/fgsea_pca_results_hallmark.xlsx"))
```
...
```{r}
plotEnrichment(gene_set[["HALLMARK_INFLAMMATORY_RESPONSE"]],
               pc_values) + labs(title="HALLMARK_INFLAMMATORY_RESPONSE")
```
...
write.xlsx(fgsea_list, file = paste0(home_dir, "/fgsea_spca_results_hallmark.xlsx"))
```
