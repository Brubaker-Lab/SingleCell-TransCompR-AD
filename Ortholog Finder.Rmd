...
human_genes <- readRDS(paste0(home_dir, "/AD_human_objects_ortholog/human_genes.RData"))
mouse_genes <- readRDS(paste0(home_dir, "/AD_mouse_objects_ortholog/mouse_genes.RData"))
```
...
# Save ortho matrix
```{r}
mouse_orthologs <- readRDS(file = paste0(home_dir, "/AD_mouse_objects_ortholog/mouse_orthologs.RData"))
```
...
```{r}
write.csv(adjusted_orthologs, file = paste0(home_dir,"/ortholog_matrix_IMPORTANT.csv"))
```
